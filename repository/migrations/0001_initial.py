# Generated by Django 2.1.2 on 2019-01-12 03:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type_id', models.IntegerField(choices=[(1, 'python'), (2, 'java'), (3, 'c++'), (4, 'php'), (5, 'shell')], default=None)),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motto', models.CharField(blank=True, max_length=256, verbose_name='个人博客座右铭')),
            ],
        ),
        migrations.CreateModel(
            name='Blog_Theme',
            fields=[
                ('nid', models.BigAutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=64, verbose_name='主题模板名称')),
                ('theme_name', models.CharField(max_length=64, verbose_name='主题展示名称')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.AddField(
            model_name='blog',
            name='theme',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='themes', to='repository.Blog_Theme', verbose_name='个人博客主题'),
        ),
        migrations.AddField(
            model_name='blog',
            name='user',
